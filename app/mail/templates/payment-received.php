...
<head>
    ...
    <title>Payment Received - Larnr</title>
</head>
    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #f4f4f4; padding: 20px;">
        <div style="background-color: white; margin: 0 auto; max-width: 600px; border-radius: 8px; overflow: hidden;">
            ...
            <div style="padding: 20px; color: #333;">
                ...
                <p>A payment of <strong>{$amount} {$currency}</strong> has been received for your lesson.</p>
                <ul>
                    <li><strong>Booking ID:</strong> {$bookingId}</li>
                    <li><strong>Student:</strong> {$studentName}</li>
                </ul>
                <p>Your earnings will be transferred to your Stripe account according to the platform's payout schedule.</p>
                <div style="text-align: center; margin: 30px 0;">
                    <a href="{$dashboardUrl}" style="background-color: #34a853; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; font-size: 16px;">View Payout Details</a>
                </div>
            </div>
