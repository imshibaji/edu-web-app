...
export default function PaymentCancel(props: { auth: AuthProps }) {
    return (
        <div className="min-h-screen bg-base-100 text-base-content">
            <Head title="Payment Cancelled · Larnr" />

            <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
                <div className="absolute -top-40 left-1/2 h-[420px] w-[680px] -translate-x-1/2 rounded-full bg-warning/15 blur-[140px]" />
            </div>
            ...
            <div className="relative z-10">
                ...
                <div className="space-y-6 py-16">
                    <div className="mx-auto max-w-md px-4 sm:px-6 lg:px-8 text-center">
                        <div className="flex size-24 items-center justify-center rounded-full bg-warning/10 mx-auto mb-6">
                        ...
                        <p className="text-lg text-base-content/60 mb-8">
                            No charges were made. Your trial lesson request is still pending.
                        </p>
                        ...
                        <div className="card card-border border-base-content/10 bg-base-content/[0.04] p-6 space-y-4">
                            ...
                            <div className="flex items-center justify-between text-sm">
                                <span className="text-base-content/60">Booking</span>
                                <span className="text-base-content font-medium">
                                    Still pending payment
                                </span>
                            </div>
                            <p className="text-sm text-base-content/60">
                                You can complete the payment from your dashboard.
                            </p>
                        </div>
